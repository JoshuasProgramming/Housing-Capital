        ...
        if($count == 1){
            ...
            <body>
                 ...
                 <section class='top' id='landingPage'>
                    <header>
                    <p><a href='#landingPage' class='landing-direct'>Housing Capital</a></p>
                        <ul class='navbar'>
                            <li><a href='/website%202/account.html'>Account</a></li>
                            <li><a href='/website%202/login.html'>Logout</a></li>
                        </ul>
                    </header>
                    <h1 class='account-header' id='thankYou' style='margin:0px 80px;'>Welcome<br><center>"; echo $name;"</center>"; echo "</h1>
                    <a href='account.php' class='Update-cta'>Update Account</a>
                    <a href='#' class='Delete-cta' id='delete_btn'>Delete Account</a>
                    
                </section>    
                <script src='/website%202/script.js'></script>
            </body>
            </html>";
